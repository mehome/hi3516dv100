...
HI_VOID SAMPLE_IVE_Od(HI_VOID)
{
    ...
    s32Ret = SAMPLE_COMM_IVE_BT1120_720P_PreView(&stViVoConfig, HI_FALSE, HI_TRUE, HI_FALSE);
    if (s32Ret != HI_SUCCESS)
    {
    ...
    SAMPLE_COMM_IVE_BT1120_720P_Stop(&stViVoConfig, HI_FALSE, HI_TRUE, HI_FALSE);
