...
HI_S32 CommSceneautoGetDRCAttr(HI_S32 s32IspDev, ADPT_SCENEAUTO_DRCATTR_S* pstAdptDRCAttr)
{
    ...
    pstAdptDRCAttr->u32AutoStrength = stDRCAttr.stAuto.u32Strength;
...
HI_S32 CommSceneautoSetDRCAttr(HI_S32 s32IspDev, const ADPT_SCENEAUTO_DRCATTR_S* pstAdptDRCAttr)
{
    ...
    stDRCAttr.stAuto.u32Strength = pstAdptDRCAttr->u32AutoStrength;
...
HI_S32 CommSceneautoGetWdrExposureAttr(HI_S32 s32IspDev, ADPT_SCENEAUTO_WDREXPOSUREATTR_S* pstAdptWdrExposureAttr)
{
	HI_S32 s32Ret = HI_SUCCESS;
    ISP_DEV IspDev = s32IspDev;
    ...
    pstAdptWdrExposureAttr->u16RatioBias = stIspWdrExposureAttr.u16RatioBias;
	
	return HI_SUCCESS;
}

HI_S32 CommSceneautoSetWdrExposureAttr(HI_S32 s32IspDev, const ADPT_SCENEAUTO_WDREXPOSUREATTR_S* pstAdptWdrExposureAttr)
{
	HI_S32 s32Ret = HI_SUCCESS;
    ISP_DEV IspDev = s32IspDev;
	ISP_WDR_EXPOSURE_ATTR_S stIspWdrExposureAttr;
    ...
    stIspWdrExposureAttr.u16RatioBias = pstAdptWdrExposureAttr->u16RatioBias;
...
HI_S32 CommSceneautoGetAEAttr(HI_S32 s32IspDev, ADPT_SCENEAUTO_AEATTR_S* pstAdptAEAttr)
{
    ...
    pstAdptAEAttr->bWDRQuick = stExposureAttr.stAuto.bWDRQuick;
    ...
    switch (stExposureAttr.stAuto.enFSWDRMode)
    {
        case ISP_FSWDR_NORMAL_MODE:
            pstAdptAEAttr->u8FSWDRMode = 0;
            break;
        case ISP_FSWDR_LONG_FRAME_MODE:
            pstAdptAEAttr->u8FSWDRMode = 1;
            break;
        default:
            pstAdptAEAttr->u8FSWDRMode = 0;
    }
...
HI_S32 CommSceneautoSetAEAttr(HI_S32 s32IspDev, const ADPT_SCENEAUTO_AEATTR_S* pstAdptAEAttr)
{
    ...
    stExposureAttr.stAuto.bWDRQuick = pstAdptAEAttr->bWDRQuick;
    ...
    switch (pstAdptAEAttr->u8FSWDRMode)
    {
        case 0:
            stExposureAttr.stAuto.enFSWDRMode = ISP_FSWDR_NORMAL_MODE;
            break;
        case 1:
            stExposureAttr.stAuto.enFSWDRMode = ISP_FSWDR_LONG_FRAME_MODE;
            break;
        default:
            stExposureAttr.stAuto.enFSWDRMode = ISP_FSWDR_NORMAL_MODE;
            break;
    }
    //printf("enFSWDRMode = %u\n", stExposureAttr.stAuto.enFSWDRMode);
...
HI_S32 CommSceneautoGetExposureInfo(HI_S32 s32IspDev, ADPT_SCENEAUTO_EXPOSUREINFO_S* pstAdptExposureInfo)
{
    ...
    pstAdptExposureInfo->u32ISO = stIspExpInfo.u32ISO;
    pstAdptExposureInfo->u32RefExpRatio = stIspExpInfo.u32RefExpRatio;
