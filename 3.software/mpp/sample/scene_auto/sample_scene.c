    ...
    while (1)
    {
        ...
        switch (choice)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                printf("please input the specialscene(0-blc, 1-ir, 2-hlc, 3-dynamic, 4-drc, 5-auto_fswdr, 6-manual_longframe, 7-manual_nomalwdr, 8-specialnone)\n");
                ...
                switch (specialscene)
                {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        eSpecialScene = SRDK_SCENEAUTO_SPECIAL_SCENE_AUTO_FSWDR;
                        ret = HI_SRDK_SCENEAUTO_SetSpecialMode(&eSpecialScene);
                        if (HI_SUCCESS != ret)
                        {
                            printf("HI_SRDK_SCENEAUTO_SetSpecialMode failed\n");
                        ...
                        break;
                    case 6:
                        eSpecialScene = SRDK_SCENEAUTO_SPECIAL_SCENE_MANUAL_LONG_FRAME;
                        ret = HI_SRDK_SCENEAUTO_SetSpecialMode(&eSpecialScene);
                        if (HI_SUCCESS != ret)
                        {
                            printf("HI_SRDK_SCENEAUTO_SetSpecialMode failed\n");
                        ...
                        break;
                    case 7:
                        eSpecialScene = SRDK_SCENEAUTO_SPECIAL_SCENE_MANUAL_NORMAL_WDR;
                        ret = HI_SRDK_SCENEAUTO_SetSpecialMode(&eSpecialScene);
                        if (HI_SUCCESS != ret)
                        {
                            printf("HI_SRDK_SCENEAUTO_SetSpecialMode failed\n");
