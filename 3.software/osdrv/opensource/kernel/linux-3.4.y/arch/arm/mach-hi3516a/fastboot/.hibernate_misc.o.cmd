cmd_arch/arm/mach-hi3516a/fastboot/hibernate_misc.o := arm-hisiv300-linux-gcc -Wp,-MD,arch/arm/mach-hi3516a/fastboot/.hibernate_misc.o.d  -nostdinc -isystem /opt/hisi-linux/x86-arm/arm-hisiv300-linux/bin/../lib/gcc/arm-hisiv300-linux-uclibcgnueabi/4.8.3/include -I/home/jun/hi3516dv100/3.software_source_code/osdrv/opensource/kernel/linux-3.4.y/arch/arm/include -Iarch/arm/include/generated -Iinclude  -include /home/jun/hi3516dv100/3.software_source_code/osdrv/opensource/kernel/linux-3.4.y/include/linux/kconfig.h -D__KERNEL__ -mlittle-endian -Iarch/arm/mach-hi3516a/include -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -fno-delete-null-pointer-checks -O2 -marm -fno-dwarf2-cfi-asm -fno-aggressive-loop-optimizations -fno-omit-frame-pointer -mapcs -mno-sched-prolog -mabi=aapcs-linux -mno-thumb-interwork -D__LINUX_ARM_ARCH__=7 -march=armv7-a -msoft-float -Uarm -Wframe-larger-than=1024 -fno-stack-protector -Wno-unused-but-set-variable -fno-omit-frame-pointer -fno-optimize-sibling-calls -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -fconserve-stack -DCC_HAVE_ASM_GOTO    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(hibernate_misc)"  -D"KBUILD_MODNAME=KBUILD_STR(hibernate_misc)" -c -o arch/arm/mach-hi3516a/fastboot/hibernate_misc.o arch/arm/mach-hi3516a/fastboot/hibernate_misc.c

source_arch/arm/mach-hi3516a/fastboot/hibernate_misc.o := arch/arm/mach-hi3516a/fastboot/hibernate_misc.c

deps_arch/arm/mach-hi3516a/fastboot/hibernate_misc.o := \
  include/linux/mm.h \
...
arch/arm/mach-hi3516a/fastboot/hibernate_misc.o: $(deps_arch/arm/mach-hi3516a/fastboot/hibernate_misc.o)
