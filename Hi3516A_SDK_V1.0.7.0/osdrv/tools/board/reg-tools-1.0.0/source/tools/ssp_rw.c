...
{
	printf("Usage: ssp_read <spi_num> <csn> <dev_addr> <reg_addr> [num_reg] [dev_width] [reg_width] [data_width].\n");
	printf("\tnum_reg and dev_width and reg_width and data_width can be omitted, the default is 0x1.\n");
	printf("eg:\n");
	printf("\tssp_read 0x0 0x0 0x2 0x0 0x10 0x1 0x1 0x1.\n");
	printf("\tssp_read 0x0 0x0 0x2 0x0. default num_reg and dev_width and reg_width and data_width is 0x1.\n");
	return;
}

static void print_w_usage(void)
{
	printf("Usage: ssp_write <spi_num> <csn> <dev_addr> <reg_addr> <data> [dev_width] [reg_width] [data_width].\n");
	printf("\tdev_width and reg_width and data_width can be omitted, the default is 0x1.\n");
	printf("eg:\n");
	printf("\tssp_write 0x0 0x0 0x2 0x0 0x65 0x1 0x1 0x1.\n");
	printf("\tssp_write 0x0 0x0 0x2 0x0 0x65. default dev_width and reg_width and data_width is 0x1.\n");
	return;
}
